...
int16_t actAngles[4][13] = {
  { 80, 80, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 8},
  { 90, 90, 90, 90, 90, 90, 85, 90, 90, 90, 90, 90, 8},
  {100,100, 90, 90, 90, 90, 80, 90, 90, 90, 90, 90, 8},
  { 90, 90, 90, 90, 90, 90, 85, 90, 90, 90, 90, 90, 8}
};
uint8_t divCounter;
uint8_t keyFrame;
...
void loop() {
  ...
  divCounter++;
  if(divCounter >= actAngles[nextKeyFrame][12]) {
    divCounter = 0;
    keyFrame = nextKeyFrame;
    nextKeyFrame++;
    if(nextKeyFrame > 3) nextKeyFrame = 0;
  }
  for(int i=0; i<12; i++) {
    tempAngles[i] = actAngles[keyFrame][i] +
              int8_t((actAngles[nextKeyFrame][i] - actAngles[keyFrame][i])
               * divCounter / actAngles[nextKeyFrame][12]);
  }
  set_angle();
  delay(30);
}
